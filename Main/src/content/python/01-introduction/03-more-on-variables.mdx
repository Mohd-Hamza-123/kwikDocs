...
Variables don’t store the actual data — they store a reference (a link or pointer) to the data in memory.
...
In Python, when you write **`a = 10`**, the following happens :_
