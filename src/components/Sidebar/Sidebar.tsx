...
const Sidebar = () => {
    ...
    return (
        isSideBarOpen && <aside className="flex flex-col w-[23%] h-screen px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 fixed top-0 z-40">
