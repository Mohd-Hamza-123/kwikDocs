...
export const svgIcons = {
    node: (props: iconsProps) => <FaNodeJs {...props} />,
    eye: (props: iconsProps) => <FaRegEye {...props} />,
    playgroundProject: (props: iconsProps) => <FaProjectDiagram {...props} />,
    code: (props: iconsProps) => <RiCodeSSlashLine {...props} />,
    logout: (props: iconsProps) => <RiLogoutCircleRLine {...props} />,
    play: (props: iconsProps) => <FaPlay {...props} />,
    copy: (props: iconsProps) => <FaRegCopy {...props} />,
    save: (props: iconsProps) => <FaRegSave {...props} />,
    brush: (props: iconsProps) => <GiLargePaintBrush {...props} />,
    terminal: (props: iconsProps) => <RiTerminalBoxLine {...props} />,
    newWindow: (props: iconsProps) => <LuSquareArrowOutUpRight {...props} />,
    arrowDropDown: (props: iconsProps) => <MdOutlineKeyboardArrowDown {...props} />,
    arrowDropRight: (props: iconsProps) => <MdOutlineKeyboardArrowRight {...props} />,
    ...
    python: (props: iconsProps) => (
        <svg {...props} xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 48 48">
