    ...
    <Prism>
      <section className="w-full sticky top-0">
        <div className="w-full bg-white z-10 shadow-md">
          <div className="h-[75px] font-bold text-gray-800 px-3 flex items-center border border-solid border-gray-200 border-t-0 border-l-0 border-r-0 justify-between">
            <h2 className="text-md lg:text-3xl w-[70%]">{doc?.title}</h2>
            <div className="flex gap-6 w-[30%] justify-end">
