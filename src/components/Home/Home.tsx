...
const Home = () => {
    ...
    return (
        <div className="bg-gray-100 dark:bg-bgDark h-[88vh] flex flex-col justify-center items-center">
            ...
            <div className="bg-white dark:bg-containerDark dark:border-gray-700 shadow-lg lg:mx-auto mx-3 max-w-4xl rounded-lg p-4 lg:p-8 text-center w-2/3 h-[57%] flex flex-col justify-around">
