...
_Python has no command for declaring a variable._
...
 _1) Viewing the Object Type :_
-------------------------------
```python
    print(type(10))  # Output: <class 'int'>
```   

_2) Viewing the Object ID (Memory Location) :_
----------------------------------------------

    print(id(10))  # Outputs the unique ID of the object '10'
    

_**3) Exploring Object Attributes :**_ 
---------------------------------------
