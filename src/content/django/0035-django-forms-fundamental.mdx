...
You can customize the widget of a form field by passing a widget object to the field.
...
class ContactForm(forms.Form):
    ...
    dob = forms.DateField(widget=forms.DateInput(attrs={'placeholder': 'Enter your date of birth'}))
    gender = forms.ChoiceField(widget=forms.RadioSelect(attrs={'placeholder': 'Select your gender'}), choices=[('M', 'Male'), ('F', 'Female')])
    skills = forms.MultipleChoiceField(widget=forms.CheckboxSelectMultiple(attrs={'placeholder': 'Select your skills'}), choices=[('HTML', 'HTML'), ('CSS', 'CSS'), ('JavaScript', 'JavaScript'), ('Python', 'Python'), ('Django', 'Django')])
